...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.pt_br = {
		...
		messages   : {
			...
			'errJqui'              : 'Configuração do JQuery UI inválida. Componentes Selectable, draggable e droppable tem que ser incluidos.',
			'errNode'              : 'elFinder requer Elemento DOM para ser criado.',
			...
			'cmdforward'   : 'Avançar',
			'cmdgetfile'   : 'Arquivos Selecionados',
			'cmdhelp'      : 'Sobre esse software',
			'cmdhome'      : 'Inicio',
			'cmdinfo'      : 'Obter informação',
			'cmdmkdir'     : 'Nova pasta',
			'cmdmkfile'    : 'Novo arquivo texto',
			'cmdopen'      : 'Abrir',
			'cmdpaste'     : 'Colar',
			'cmdquicklook' : 'Visualizar',
			'cmdreload'    : 'Recarregar',
			'cmdrename'    : 'Renomear',
			'cmdrm'        : 'Deletar',
			'cmdsearch'    : 'Procurar Arquivos',
			'cmdup'        : 'Ir para um diretório acima',
			'cmdupload'    : 'Subir arquivos',
			'cmdview'      : 'Ver',
			'cmdresize'    : 'Redimencionar e rotacionar',
			'cmdsort'      : 'Organizar',
			'cmdnetmount'  : 'Montar volume de rede', // added 18.04.2012
			'cmdnetunmount': 'Desmontar', // from v2.1 added 30.04.2012
			'cmdplaces'    : 'To Places', // added 28.12.2014
			'cmdchmod'     : 'Change mode', // from v2.1 added 20.6.2015
			'cmdopendir'   : 'Abrir uma pasta', // from v2.1 added 13.1.2016
			...
			'btnFileName':'Nome',  // from v2.1 added 22.5.2015
			'btnSaveClose': 'Salvar & Fechar', // from v2.1 added 12.6.2015
			'btnBackup' : 'Backup', // fromv2.1 added 28.11.2015

			/******************************** notifications ********************************/
			'ntfopen'     : 'Abrir uma pasta',
